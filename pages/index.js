      ...
      <main>
        ...
        <section className="px-4">
          <div className="relative w-full max-w-lg">
            ...
            <div className="absolute top-0 -right-14 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob animation-delay-2000"></div>
